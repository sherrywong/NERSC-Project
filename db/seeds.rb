...
Risk.create_risk(1, 1, {:cost=> 3, :schedule => 2, :technical => 1, :status=> "active", :early_impact=> "2008-11-20", :last_impact=> "2013-10-20", :owner_id=>"admin", :description => "Project 1 risk 1", :probability => 2, :title => "Risk"}) 
