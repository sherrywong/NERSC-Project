...
Scenario: Risk owners can deactivate a risk.
    ...
    Given that a risk exists with title "P3 Test Risk3", owner "lz", early impact "2013-11-20", and last impact "2014-10-20" for project "First Project"
...
Scenario: Project owners cannot deactivate a risk.
    ...
    Given that a risk exists with title "P3 Test Risk2", owner "ag", early impact "2013-11-20", and last impact "2014-10-20" for project "First Project"
...
Scenario: A project member cannot deactivate a risk.
    Given I am logged in as Linda
    Given that a risk exists with title "P3 Test Risk4", owner "ag", early impact "2013-11-20", and last impact "2014-10-20" for project "First Project"
